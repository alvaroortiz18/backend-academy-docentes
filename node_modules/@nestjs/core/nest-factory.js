...
const console_logger_service_1 = require("@nestjs/common/services/console-logger.service");
...
>>>>>>> 6c53bd457e41c1ffae31a9486339c4dadf79ee43
    ...
    registerLoggerConfiguration(options) {
        ...
        if (logger !== true && !(0, shared_utils_1.isNil)(logger)) {
            ...
            const consoleLogger = new console_logger_service_1.ConsoleLogger({ forceConsole: true });
            logger_service_1.Logger.overrideLogger(consoleLogger);
        }
        if (bufferLogs) {
